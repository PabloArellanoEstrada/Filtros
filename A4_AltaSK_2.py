...
A4_AltaSK_2.cir to work, a netlist file is required."""
  file_extension = "cir"
else:
  file_extension = "asc"
...
lti = signal.lti([num1_sk_high_2, num2_sk_high_2, num3_sk_high_2], [den1_sk_high_2, den2_sk_high_2, den3_sk_high_2])
