...
A8_AltaMFF_2.cir to work, a netlist file is required."""
  file_extension = "cir"
else:
  file_extension = "asc"
...
lti = signal.lti([num1_MMF_high_2, num2_MMF_high_2, num3_MMF_high_2], [den1_MMF_high_2 , den2_MMF_high_2, den3_MMF_high_2])
