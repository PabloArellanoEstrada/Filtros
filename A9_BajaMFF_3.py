...
A9_BajaMFF_3.cir to work, a netlist file is required."""
  file_extension = "cir"
else:
  file_extension = "asc"
...
lti = signal.lti([num1_MMF_low_3], [den1_MMF_low_3 , den2_MMF_low_3, den3_MMF_low_3, den4_MMF_low_4 ])
