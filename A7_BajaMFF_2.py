...
A7_BajaMFF_2.cir to work, a netlist file is required."""
  file_extension = "cir"
else:
  file_extension = "asc"
...
lti = signal.lti([num_MMF_low_2], [den1_MMF_low_2, den2_MMF_low_2, den3_MMF_low_2])
