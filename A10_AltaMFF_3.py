...
A10_AltaMFF_3.cir to work, a netlist file is required."""
  file_extension = "cir"
else:
  file_extension = "asc"
...
dummy, signal_b1 = apply_ltspice_filter(
      f"A10_AltaMFF_3.{file_extension}",
      time, signal_a,
...
lti = signal.lti([num1_MMF_high_3, num2_MMF_high_3, num3_MMF_high_3, num4_MMF_high_3], [den1_MMF_high_3, den2_MMF_high_3, den3_MMF_high_3, den4_MMF_high_3])
